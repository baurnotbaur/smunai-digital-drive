...
export const DICTIONARY: Record<Lang, Translations> = {
  kz: {
    ...
    hero: {
      badge: "1996–2026 · 30 жыл",
      title: "Жезқазған, Сәтбаев және Астананы 30 жыл бойы жанармаймен қамтамасыз етіп келеміз",
    ...
    servicesSection: {
      ...
      s5Title: "Тегін дөңгелек үрлеу",
      s5Desc: "Жол қауіпсіздігі үшін кез келген уақытта дөңгелек қысымын тексеру және автоматты үрлеу қызметі.",
    ...
    promo: {
      title: "30 жылдық мерейтойлық акциялар",
      subtitle: "С-Мұнай желісінің 30 жылдығына орай тұтынушыларымызға арналған арнайы ұтыстар мен сыйлықтар.",
      card1Badge: "Мерейтойлық ұтыс",
      card1Title: "30 жылдыққа орай құнды сыйлықтар",
    ...
    about: {
      title: "Біз туралы",
      text: "1996 жылдан бастап біз Ұлытау облысы мен Астана қаласында жеке ЖҚС желісін дамытып келеміз. Бір станциядан бастап, бүгінде сегізге жеттік. Біз жергілікті ұжымбыз: өз қалаларымыз бен тұтынушыларымызды жақсы білеміз және 30 жыл бойы жинаған адал абыройымызбен жанармай сапасына кепілдік береміз.",
      badge: "1996–2026 · 30 жыл",
    },
    jobs: {
    ...
    contacts: {
      ...
      instaDesc: "Желінің барлық жаңалықтары, мерекелік акциялар, 30 жылдық ұтыстар және Direct арқылы жедел байланыс.",
    ...
    footer: {
      rights: "© С-Мұнай, 1996–2026. Барлық құқықтар қорғалған.",
    },
    cardsPage: {
  ...
  ru: {
    ...
    hero: {
      badge: "1996–2026 · 30 лет",
      title: "Заправляем Жезказган, Сатпаев и Астану уже 30 лет",
    ...
    servicesSection: {
      ...
      s5Title: "Бесплатная подкачка шин",
      s5Desc: "Автоматические компрессоры с точным манометром на станциях для безопасного давления в шинах.",
    ...
    promo: {
      title: "Акции к 30-летию сети",
      subtitle: "Специальные предложения, розыгрыши призов и подарки для наших любимых клиентов.",
      card1Badge: "Юбилейный розыгрыш",
      card1Title: "Ценные призы к 30-летию компании",
    ...
    about: {
      title: "О нас",
      text: "С 1996 года мы развиваем собственную сеть АЗС в Улытауской области и Астане. Начинали с одной станции — сегодня нас восемь. Мы местная команда: знаем свои города, своих клиентов и отвечаем за качество топлива репутацией, заработанной за 30 лет.",
      badge: "1996–2026 · 30 лет",
    },
    jobs: {
      title: "Вакансии",
    ...
    contacts: {
      ...
      instaHandle: "@azs_smunai",
      instaDesc: "Все актуальные новости сети, праздничные акции, розыгрыши призов к 30-летию компании и оперативная связь в Direct.",
      instaBtn: "Перейти в @azs_smunai",
      geoTitle: "География станций сети",
      geoSubtitle: "8 станций в 3 регионах",
    },
    footer: {
      rights: "© С-Мунай, 1996–2026. Все права защищены.",
    },
    cardsPage: {
  ...
  en: {
    ...
    hero: {
      badge: "1996–2026 · 30 Years",
      title: "Fueling Zhezkazgan, Satpayev, and Astana for 30 years",
      ...
      featureSubtitle: "Trusted gas station network since 1996",
    ...
    servicesSection: {
      ...
      s5Title: "Free Tire Inflation",
      s5Desc: "Automated high-precision digital tire pressure gauges and compressors for road safety.",
      s6Title: "All Modern Payment Methods",
      s6Desc: "Kaspi QR, Halyk QR, contactless bank cards, cash, corporate fuel cards, and vouchers.",
    },
    promo: {
      title: "30th Anniversary Promotions",
      subtitle: "Special prize draws and fuel discounts celebrating our 30 years on the road.",
      card1Badge: "Anniversary Draw",
      card1Title: "Valuable Prizes for our 30th Year",
    ...
    about: {
      title: "About Us",
      text: "Since 1996, we have developed our own gas station network across the Ulytau region and Astana. Starting from a single station, today we operate eight. We are a local team: we know our cities and our drivers, standing behind our fuel quality with 30 years of hard-earned reputation.",
      badge: "1996–2026 · 30 Years",
    },
    jobs: {
      title: "Careers",
    ...
    contacts: {
      ...
      instaHandle: "@azs_smunai",
      instaDesc: "All latest network updates, 30th anniversary prize draws, promos, and direct communication in Direct.",
      instaBtn: "Open @azs_smunai",
      geoTitle: "Network Station Footprint",
      geoSubtitle: "8 stations across 3 regions",
    },
    footer: {
      rights: "© S-Munai, 1996–2026. All rights reserved.",
    },
    cardsPage: {
