  ...
  head: () => ({
    meta: [
      { title: "С-Мунай — сеть АЗС в Жезказгане, Сатпаеве и Астане" },
      {
        name: "description",
        content:
          "С-Мунай — семейная сеть из 8 АЗС в Жезказгане, Сатпаеве и Астане с 1996 года: качественное топливо, магазин и кофе с собой.",
      },
      { property: "og:title", content: "С-Мунай — сеть АЗС в Жезказгане, Сатпаеве и Астане" },
      {
        property: "og:description",
        content: "С-Мунай — семейная сеть из 8 АЗС в Жезказгане, Сатпаеве и Астане с 1996 года: качественное топливо, магазин и кофе с собой.",
      },
    ],
  }),
  component: Index,
            ...
            <div className="soft-card grid gap-8 p-7 sm:p-10 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-4 text-foreground/75">
                  ...
                  закрывающие документы, персональные условия для компаний Жезказгана, Сатпаева и
                  Астаны.
                </p>
                <div className="mt-7">
                  <B2BDialog />
